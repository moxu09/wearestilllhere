export default function Loading() {
  return (
    <main className="fixed inset-0 z-[9999] flex min-h-screen items-center justify-center overflow-hidden bg-[#08080c] text-white">
      ...
      <div className="relative flex flex-col items-center text-center">
        <div className="relative mb-8 flex h-24 w-24 items-center justify-center">
          <div className="absolute h-24 w-24 rounded-full border border-purple-300/20" />
          <div className="absolute h-24 w-24 animate-spin rounded-full border-2 border-transparent border-t-purple-300 border-r-pink-300" />
          <div className="absolute h-14 w-14 rounded-full bg-purple-300/10 blur-md" />
          <div className="h-6 w-6 rounded-full bg-purple-200 shadow-[0_0_35px_rgba(216,180,254,0.95)]" />
        </div>
